...
class categorie
{
    ...
    {
        $sql = mysql_query("SELECT COUNT(produits.ref_produit) FROM produits, produits_categorie, categorie WHERE produits_categorie.ref_produit = produits.ref_produit
    ...
    {
        $sql = mysql_query("SELECT COUNT(produits.ref_produit) FROM produits, produits_subcategorie, subcategorie WHERE produits_subcategorie.ref_produit = produits.ref_produit
