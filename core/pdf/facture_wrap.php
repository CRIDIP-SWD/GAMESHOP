...
<html>
    ...
    <body>
        ...
        <table style="width: 100%; border: 2px solid #8c8c8c; border-radius: 5px;" cellspacing="0" cellpadding="0">
            <thead>
                <tr>
                    <th style="text-align: center; border-bottom: 3px solid #8c8c8c; border-right: 1px solid #8c8c8c; padding: 5px 5px 5px 5px;">Référence</th>
                    <th style="text-align: center; border-bottom: 3px solid #8c8c8c; border-right: 1px solid #8c8c8c; padding: 5px 5px 5px 5px;">Description</th>
                    <th style="text-align: center; border-bottom: 3px solid #8c8c8c; border-right: 1px solid #8c8c8c; padding: 5px 5px 5px 5px;">Prix Unitaire</th>
                    <th style="text-align: center; border-bottom: 3px solid #8c8c8c; border-right: 1px solid #8c8c8c; padding: 5px 5px 5px 5px;">Qte</th>
                    <th style="text-align: center; border-bottom: 3px solid #8c8c8c; padding: 5px 5px 5px 5px;">Total</th>
                </tr>
            </thead>
            <tbody>
            <?php
