                    ...
                    <div class="tab-content clearfix gamercard" id="psn">
                        ...
                        <div class="tabs side-tabs clearfix" id="tab-4">
                            ...
                            <?php if(empty($info_client['pseudo_psn'])){ ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <a class="button button-desc button-3d button-rounded button-blue center" data-target="#add-psn">Lié votre compte Playstation Network<span>Bénéficier de 100 Points de fidélités</span></a>
                                    </div>
                                </div>
                                <div class="modal1 mfp-hide" id="add-psn">
