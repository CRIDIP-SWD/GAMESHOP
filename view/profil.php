                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if($cmd->statut == 3 OR $cmd->statut == 4 OR $cmd->statut == 5): ?>
                                                    <a href="core/pdf/facture.php?num_commande=<?= $cmd->num_commande; ?>"><i class="icon-file-text icon-2x text-info" data-toggle="tooltip" data-original-title="Votre facture"></i></a>
                                                <?php endif; ?>
                                            </td>
                                            <td class="text-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 75%; padding-bottom: 10px; padding-top: 10px; font-weight: 700;">
                                                        <?php
                                                        $cmd_sortie = $DB->count("SELECT COUNT(produits.ref_produit) FROM commande_article, produits WHERE commande_article.ref_produit = produits.id AND produits.date_sortie >= :date_jour AND commande_article.num_commande = :num_commande", array(
                                                            "date_jour" => strtotime(date("d-m-Y")),
                                                            "num_commande" => $num_commande
                                                        ));
                                                        $cmd_stock = $DB->count("SELECT COUNT(produits.ref_produit) FROM commande_article, produits WHERE commande_article.ref_produit = produits.id AND produits.stock < :stock AND commande_article.num_commande = :num_commande", array(
                                                            "stock" => 0,
                                                            "num_commande" => $num_commande
                                                        ));
                                                        ?>
