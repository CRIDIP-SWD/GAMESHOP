...
<!-- Page Title
		============================================= -->
<section id="page-title" <?php if(!empty($produit['banner'])){echo "style='background-image: url(".$constante->getUrl(array(), false, true)."produit/banner/banner_".$produit['banner'].".jpg) no-repeat' class='img-responsive'";} ?>>
