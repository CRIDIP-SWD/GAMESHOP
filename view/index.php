        ...
        <div class="tp-banner" >
            <ul>    <!-- SLIDE  -->
                ...
                <li data-transition="boxslide" data-slotamout="7" data-link="#">
                    ...
                    <div class="caption sft" style="font-size: 56px;" data-x="800" data-y="500" data-speed="700" data-start="2500" data-easing="easeOutLeft"><a href="#" class="btn btn-primary btn-lg"><i class="icon-line2-basket-loaded"></i> <span>TEST</span></a></div>
                </li>
            </ul>
