        ...
        <div class="tp-banner" >
            <ul>    <!-- SLIDE  -->
                <!--<li data-transition="boxslide" data-slotamout="7" data-link="#">
                    ...
                    <div class="caption sft" data-x="420" data-y="500" data-speed="700" data-start="4000" data-easing="easeOutLeft">
                ...
                <li data-transition="boxslide" data-slotamout="7">
                    ...
                    <div class="caption sft" style="font-size: 56px; color: #fff;" data-x="800" data-y="500" data-speed="700" data-start="2500" data-easing="easeOutLeft">
                        <div class="btn-group">
                            ...
                            <button class="btn btn-default btn-lg" onclick="window.location.href='index.php?view=produit&ref_produit=PS4NUNS4'">Précommander Maintenant sur PS4</button>
                        </div>
                    </div>
                ...
                <li data-transition="3dcurtain-horizontal" data-link="">
                    ...
                    <div class="caption sft" data-x="center" data-hoffset="-423" data-y="center" data-speed="700" data-start="1000" data-easing="easeOutBack">
                        <div style="font-size: 49px; font-weight: bold;">PRECOMMANDER MAINTENANT !</div>
                    </div>
                </li>
            </ul>
                            ...
                            <div class="product clearfix">
                                <div class="product-image">
                                    ...
                                    <div class="product-overlay">
                                        <a href="core/panier.php?action=ajout&l=<?= $new->ref_produit; ?>&q=1&p=<?= $new->prix_vente; ?>" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Ajouter au paniers</span></a>
