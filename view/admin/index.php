                        ...
                        <div class="tab-pane" id="produit">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php
                                    $sql_produit = $DB->query("SELECT * FROM produits WHERE statut_global = :statut ORDER BY date_sortie ASC LIMIT 5", array("statut" => 2));
...
<?php if(isset($_GET['sub']) && $_GET['sub'] == 'produits'): ?>
    ...
    <?php if(isset($_GET['data']) && $_GET['data'] == 'view_produit'): ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <div class="radio-custom radio-primary">
                                        <input type="radio" id="augdim1" name="augdim" value="1">
                                        <label for="augdim1">Augmentation</label>
                                    </div>
                                    <div class="radio-custom radio-primary">
                                        <input type="radio" id="augdim2" name="augdim" value="0">
        ...
        <div id="add-promo" class="modal-block modal-block-lg modal-header-color modal-block-primary mfp-hide">
            <section class="panel">
                <header class="panel-heading">
                    <h2 class="panel-title">Nouvelle Promotion</h2>
                </header>
                <form id="summary-form" class="form-horizontal" action="core/admin/produit.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="ref_produit" value="<?= $ref_produit; ?>">
                    <div class="panel-body">
                    ...
                    <footer class="panel-footer">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-primary" type="submit" name="action" value="add-promo">Valider</button>
                                <button class="btn btn-default modal-dismiss">Annuler</button>
                            </div>
                        </div>
                    </footer>
...
<?php if(isset($_GET['sub']) && $_GET['sub'] == 'commande'): ?>
                                    ...
                                    <table class="table table-bordered table-striped mb-none" id="datatable-default">
                                        ...
                                        foreach($sql_commande as $commande):
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-xs" href="index.php?view=admin_sha&sub=commande&data=view_commande&num_commande=<?= $commande->num_commande; ?>"><i class="fa fa-search"></i> Voir la commande</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
    ...
    <?php endif; ?>
    <?php if(isset($_GET['data']) && $_GET['data'] == 'view_commande'): ?>
        <?php
        ...
        <section role="main" class="content-body">
            <header class="page-header">
                <h2><i class="fa fa-file"></i> COMMANDES N° <?= $commande[0]->num_commande; ?></h2>
