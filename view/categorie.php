                            ...
                            <div class="product clearfix">
                                <div class="product-image">
                                    ...
                                    <div class="product-overlay">
                                        <a href="core/panier.php?action=ajout&l=<?= $produit->id; ?>&q=1&p=<?= $produit->prix_vente; ?>" class="add-to-cart"><i class="icon-shopping-cart"></i><span> Ajouter au panier</span></a>
