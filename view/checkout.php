...
<?php if(isset($_GET['sub']) && $_GET['sub'] == 'adresse'): ?>
    ...
    <section id="content">
        <div class="content-wrap">
            <ul class="process-steps process-5 bottommargin clearfix">
                <li>
                    <a class="i-circled i-alt divcenter bg-success" href="#"><i class="icon-shopping-cart"></i></a>
                    <h5>Mon Panier</h5>
                </li>
                <li class="active">
                    <a class="i-circled i-alt divcenter bgcolor" href="#"><i class="icon-line-marquee-plus"></i></a>
                    <h5>Adresse</h5>
                </li>
                <li>
                    <a class="i-circled i-alt divcenter" href="#"><i class="icon-truck2"></i></a>
    ...
    <section id="content">
        <div class="content-wrap">
            <ul class="process-steps process-5 bottommargin clearfix">
                ...
                <li>
                    <a class="i-circled i-alt divcenter bg-success" href="#"><i class="icon-line-marquee-plus"></i></a>
                    <h5>Adresse</h5>
                </li>
                <li class="active">
                    <a class="i-circled i-alt divcenter bgcolor" href="#"><i class="icon-truck2"></i></a>
                    <h5>Livraison</h5>
                </li>
                <li>
                    <a class="i-circled i-alt divcenter" href="#"><i class="icon-line2-credit-card"></i></a>
    ...
    <section id="content">
        <div class="content-wrap">
            <ul class="process-steps process-5 bottommargin clearfix">
                ...
                <li>
                    <a class="i-circled i-alt divcenter bg-success" href="#"><i class="icon-truck2"></i></a>
                    <h5>Livraison</h5>
                </li>
                <li class="active">
                    <a class="i-circled i-alt divcenter bgcolor" href="#"><i class="icon-line2-credit-card"></i></a>
                    <h5>Paiement</h5>
                </li>
                <li>
                    <a class="i-circled i-alt divcenter" href="#"><i class="icon-check-sign"></i></a>
                        ...
                        <div class="well bounceInLeft animated" data-animation="bounceInLeft">
                            ...
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right; font-size: 15px; padding-right: 5px; padding-bottom: 10px;"><?= $fonction->number_decimal($cmd[0]->prix_envoie); ?></td>
                                </tr>
                                <tr>
